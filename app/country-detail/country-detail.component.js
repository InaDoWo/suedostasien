...
component('countryDetail', {
    ...
    controller: ['$http', '$routeParams',
        function CountryDetailController($http, $routeParams) {
            ...
            $http.get('http://api.openweathermap.org/data/2.5/weather?q=' + $routeParams.capital + '&lang=de&units=metric&APPID=a39a0395d8d318e22241cf4a05cf50e2').then(function(response) {
